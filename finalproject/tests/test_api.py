...
async def login(payload: LoginRequest):
    from .auth import TOKEN_MINUTES, authenticate, create_access_token
...
@app.post("/submit_query", response_model=TicketResponse, status_code=status.HTTP_201_CREATED)
